...
export const FLASK_PUT_NPCS_URL = FLASK_URL + "/api/world/npcs";
export const FLASK_PUT_CITIES_URL = FLASK_URL + "/api/world/cities";
export const FLASK_PUT_CONTINENTS_URL = FLASK_URL + "/api/world/continents";
